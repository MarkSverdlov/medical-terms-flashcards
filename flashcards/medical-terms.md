...
| -glycemia | סוכר |
| -meter | מכשיר מדידה |
| ECG | מכשיר אק"ג לרישום הפעילות החשמלית של הלב |
| ecto-, exo- | מחוץ | הריון אקטופי (מחוץ לרחם) ectopic |
| endo- | פנימי | endocardium = השכבה הפנימית של הלב, endothelium = השכבה הפנימית של כלי דם |
| epi- | מעל, חיצוני | epicardium = השכבה החיצונית של הלב, epithelium = השכבה החיצונית של כלי הדם |
| inter- | בין | intercostal = בין הצלעות |
| post- | לאחר, אחרי | postnatal = לאחר הלידה |
| pre- | לפני | preoperative = לפני הניתוח |
| anterior | קדמי | |
| posterior | אחורי | |
| superior | עליון | |
| inferior | תחתון | |
...
| -itis | דלקת (סיומת) | appendicitis = דלקת בתוספתן |
| -osis | מצב של | cyanosis = (מצב של) כיחלון |
| -paresis | שיתוק | hemiparesis = שיתוק חצי גוף |
| leuko- | לבן | |
| erythro- | אדום | |
| cyano- | כחול | |
...
מושגים כללים נפוצים
==================
| term | interpretation | initials |
| ---- | ------------- |
| S/P | מצב לאחר | Status Post |
| CABG | ניתוח מעקפים | Coronary Artery Bypass Graft |
| PTCA | צנתור | Percutaneous Transluminal Coronary Angioplasty |
| AMI | אוטם לבבי חריף | Acute myocardial infraction |
| CHF | אי ספיקת לב | Congestive Heart Failure |
| CRF | אי ספיקת כליות | Chronic Renal Failure |
| ICU | טיפול נמרץ כללי | Intrusive Care Unit |
| CCU | טיפול נמרץ לב | Coronary care unit |
| EMS | שירותי רפואה דחופה | Emergency Medical Services |
| ALS | תמיכת חיים מתקדמת | Advanced Life Support |
| BLS | תמיכת חיים בסיסית | Basic Life Support |
...
| physiology | תורת התהליכים הכימיים בגוף | |
| pathology | תורת דרכי הפעולה של המחלות | |
| pathophysiology | תורה שחוקרת את הפיזיולוגיה של מחלות | חוקרת את השתלשלות האירועים המובילים להופעת תסמיני המחלה ואת הדרכים בהן משפיעים גורמי מחלה שונים על תפקוד הגוף |
| homeostasis | כושרו של יצור חי לשמור על סביבה פנימית יציבה | רמת סוכר בדם, טמפ' הגוף וכו' | |
| diffusion | מעבר של חומר (solute) דרך ממברנה חדירה מריכוז גבוה לריכוז נמוך | |
| osmosis | מעבר נוזלים (solvent) (דרך ממברנה חדירה למחצה) מריכוז נמוך לריכוז ג | |
...
| ---- | -------------- | ----------- |
| cardiopulmonary resuscitation | החייאת לב ריאה | |
...
| clinical death | היעדר נשימה ודופק | |
...
| synapse | רכיב בין נוירונים שמעביר אותו כימיים או חשמליים | רכיב בין נוירונים שמעביר אותו חשמליים או נוירוטרנסמיטרים (תלוי בסוג) |
| neurotransmitter | חומר כימי שמעביר אינפורמציה בין נוירונים | החומר שמעביר אינפורמציה בין הנוירונים בסינפסות |
...
| sympathetic nervous system | מערכת העצבים שאחראית על הפעילות האוטונומית במצבי דחק | קשורה לפעילויות מע' העצבים האוטונומית בעת דחק |
| parasympathetic nervous system | מערכת העצבים שאחראית על הפעילות האוטונומית במצבי רוגע | קשורה לפעיליות של מע' העצבים בעת רגיעה |
